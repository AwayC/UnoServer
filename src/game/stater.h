...
namespace uno
{
    ...
    public:
        struct Stat
        {
            ...
            std::unordered_map<int, int> draw_cards; // 抽到各种牌的数量
            std::unordered_map<int, int> draw_black_cards; // 抽到各种王牌的数量

            int total_play = 0; // 总共打牌的数量
            int play_ahead = 0; // 抢牌数量
            std::unordered_map<int, int> play_cards; // 打出各种颜色牌的数量
            std::unordered_map<int, int> play_black_cards; // 打出各种王牌的数量
